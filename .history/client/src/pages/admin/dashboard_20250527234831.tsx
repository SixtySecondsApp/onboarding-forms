                ...
                <table className="w-full">
                  <thead className={`${theme === 'dark' ? 'bg-gray-800/50' : 'bg-gray-50'}`}>
                    <tr>
                      ...
                      <th className="text-left p-4 font-medium text-sm w-80">Progress</th>
                      ...
                      >
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-4">
                            <div className={`flex-1 h-3 rounded-full ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-200'} overflow-hidden min-w-[200px]`}>
                              <div 
                              ...
                              >
                                {form.progress > 0 && (
                                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400/30 to-purple-400/30 animate-pulse rounded-full"></div>
                                )}
                              </div>
                            </div>
                            <div className="flex flex-col items-end min-w-[60px]">
                              <span className="text-sm font-semibold">{form.progress}%</span>
                              <span className="text-xs text-muted-foreground">
                                {form.status === 'completed' ? 'Complete' : 
